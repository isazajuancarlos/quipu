...
> (XChaCha20-Poly1305, Argon2id, HKDF, X25519, ML-KEM-1024, ristretto255). The
> parts I think are interesting are the *composition*: a hybrid post-quantum mode
> (X25519 + ML-KEM-1024, X-Wing-style transcript binding), a *verifiable* online
...
> - Hybrid post-quantum KEM (X25519 + ML-KEM-1024, FIPS-203), X-Wing-style binding
...
> primitives only (ML-KEM-1024 + X25519, XChaCha20-Poly1305, verifiable OPRF).
